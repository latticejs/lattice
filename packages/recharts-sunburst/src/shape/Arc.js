...
// import pureRender from 'recharts/lib/util/PureRender';
import { PRESENTATION_ATTRIBUTES, EVENT_ATTRIBUTES, getPresentationAttributes,
  filterEventAttributes } from 'recharts/lib/util/ReactUtils';
...
const getPath = (nodeProps) => {
  return dataArc(nodeProps);
}
...
class Arc extends Component {
  ...
  render() {
    ...
    const layerClass = classNames('recharts-arc', className);
